        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label htmlFor="date" className="block text-gray-700 font-semibold mb-1">Preferred Date</label>
                <input
                  type="date"
                  id="date"
                  name="date"
              ...
              <div>
                <label htmlFor="message" className="block text-gray-700 font-semibold mb-1">Special Requirements</label>
                <textarea
                  id="message"
                  name="message"
